                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="p_desc" class="form-control" id="p_desc" cols="30" rows="10">{{old('p_desc')}}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="category_id">
                                    ...
                                    <option value="{{$category->id}}" class="form-control @error('category_id') is-invalid @enderror">{{ $category->name }}</option>
                                    @endforeach
                                  </select>
                                  @error('category_id')
                                    <div class="invalid-feedback">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" name="sizes" id="sizes" class="form-control @error('sizes')is-invalid @enderror">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="colors" id="colors" class="form-control @error('colors')is-invalid @enderror">
